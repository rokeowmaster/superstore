  ...
  return (
    <>
      ...
      <main className="m-8 flex flex-wrap">
            ...
            <div key={product._id} className="sm:w-50 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="p-8 rounded-t-lg" src={product.productImage.image} alt="product image" />
                </a>
