  ...
  return (
    <nav className='bg-blue-200 h-12 fixed flex w-full z-20 justify-between'>
        ...
        <ul className='sm:flex hidden m-2 justify-between'>
            ...
            <svg data-collapse-toggle="navbar-hamburger" className="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
